(module
 ...
 (func $~lib/internal/typedarray/TypedArray<u8_u32>#constructor (; 18 ;) (; has Stack IR ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (if
   (i32.gt_u
 ...
 (func $lib/contract/Contract#getStream (; 20 ;) (; has Stack IR ;) (type $FUNCSIG$i) (result i32)
  (local $0 i32)
  (local $1 i32)
  (drop
 ...
 (func $~lib/internal/arraybuffer/reallocateUnsafe (; 27 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (if
   (i32.gt_s
 ...
 (func $~lib/array/Array<u8>#push (; 28 ;) (; has Stack IR ;) (type $iii) (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (set_local $4
 ...
 (func $lib/utils/toUTF8Array (; 29 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $lib/utils/string2cstr (; 30 ;) (; has Stack IR ;) (type $ii) (param $0 i32) (result i32)
  (i32.add
   (i32.load
 ...
 (func $src/helloworld/HelloWorld#create (; 31 ;) (; has Stack IR ;) (type $iiv) (param $0 i32) (param $1 i32)
  (local $2 i32)
  (call $lib/env/printi
   (i64.load
    (get_local $0)
 ...
 (func $lib/utils/assert (; 32 ;) (; has Stack IR ;) (type $FUNCSIG$v)
 ...
 (func $src/helloworld/HelloWorld#apply (; 33 ;) (; has Stack IR ;) (type $iIv) (param $0 i32) (param $1 i64)
  (if
   (i64.eq
    (get_local $1)
    (call $lib/utils/N
   ...
   (call $src/helloworld/HelloWorld#create
    ...
    (call $src/models/Create.fromStream
     (call $lib/contract/Contract#getStream)
    )
   )
   (call $lib/utils/assert)
  )
 )
 (func $src/helloworld/apply (; 34 ;) (; has Stack IR ;) (type $IIIv) (param $0 i64) (param $1 i64) (param $2 i64)
 ...
 (func $start (; 35 ;) (; has Stack IR ;) (type $v)
 ...
 (func $null (; 36 ;) (; has Stack IR ;) (type $v)
  (nop)
 )
)
